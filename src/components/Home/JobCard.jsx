        ...
        <div className='w-full max-w-full shadow-lg bg-primary-gray rounded-xl'>
            <div className=" text-white p-6 pb-3 bg-primary-gray shadow-lg rounded-xl">
                ...
                <div className="flex items-center mb-4">
                    ...
                    />
                    <div className="ml-3">
                        <h3 className="font-bold">Gabimaru</h3>
                        <p className="text-sm text-gray-400">May 13</p>
                    </div>
                </div>

                {/* Post Info */}
                <h4>Looking For An Experienced YouTube Thumbnail Designer For A DISNEY channel</h4>
                <p className="text-gray-300 text-sm mb-4">
                    Description: This is a LONG-TERM position with GREAT benefits such as bonuses and raises based on quality work and performance! Examples: Below are links to my competitors' channels for you to refer to that will give you a better understanding of the level of quality we need from you.
                </p>
                ...
                <div className="flex justify-between items-center pr-2">
                    <div className="flex items-center">
                        <button className="flex items-center space-x-1 text-gray-400">
                            ...
                            <span><p className="text-sm mr-2">74.5K Likes</p></span>
                        </button>
